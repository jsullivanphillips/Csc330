...
class Point < GeometryValue
  ...
  def intersectWithSegmentAsLineResult seg
    def inbetween(v, end1, end2)
      (end1 - 0.00001 <= v && v <= end2 + 0.00001) || (end2 - 0.00001 <= v && v <= end1 + 0.00001)
    end
...
class Intersect < GeometryExpression
  ...
  def eval_prog env 
    #evaluate the expression then apply intersect to the result
    r1 = @e1.eval_prog env
    r2 = @e2.eval_prog env
    r1.intersect(r2)
  end
...
class Let < GeometryExpression
  ...
  # MY CODE HERE:
  def eval_prog env 
    #bind e1 to s in a new environment, then call eval prog for e2 within the new environment
...
class Shift < GeometryExpression
  ...
  # MY CODE HERE:
  def eval_prog env 
    #evaluate the expression then apply shift to the result
    result = @e.eval_prog env
    result.shift(@dx, @dy)
  end
  def preprocess_prog
